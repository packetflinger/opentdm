...
void Use_Breather(edict_t *ent, const gitem_t *item) {
    ...
    if (ent->client->breather_framenum > level.framenum) {
        ent->client->breather_framenum += SECS_TO_FRAMES(30);
    } else {
        ent->client->breather_framenum = level.framenum + SECS_TO_FRAMES(30);
    }
}
...
void Use_Envirosuit(edict_t *ent, const gitem_t *item) {
    ...
    if (ent->client->enviro_framenum > level.framenum) {
        ent->client->enviro_framenum += SECS_TO_FRAMES(30);
    } else {
        ent->client->enviro_framenum = level.framenum + SECS_TO_FRAMES(30);
    }
}
...
qboolean Pickup_Ammo(edict_t *ent, edict_t *other) {
    ...
    if (weapon && !oldcount) {
        if (other->client->weapon
                != ent->item&& other->client->weapon == GETITEM (ITEM_WEAPON_BLASTER)) {
    ...
    ITEM_INDEX(ent->item) == ITEM_AMMO_GRENADES && oldcount == 0
...
void Drop_Ammo(edict_t *ent, const gitem_t *item) {
    ...
    if (ent->client->weapon && ent->client->weapon->tag == AMMO_GRENADES
    ...
    // special case, grenades are ammo and their own weapon
    if (index == ITEM_AMMO_GRENADES && ent->client->inventory[index] == 0
...
qboolean Pickup_Armor(edict_t *ent, edict_t *other) {
    ...
    if (other->client->pers.armor_mask && g_armor_timer->value) {
        if (index != ARMOR_SHARD) {
            ...
            if (i < ARMOR_MAX
                    && (other->client->pers.armor_mask & armorvotes[i].value)) {
                other->client->pers.item_timer[TIMER_ARMOR] = level.framenum
                        + SECS_TO_FRAMES(20);
                other->client->pers.item_timer_icon[TIMER_ARMOR] =
...
void Touch_Item(edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf) {
    ...
    if (taken) {
        ...
        if (ent->item->pickup == Pickup_Health) {
            if (ent->count == 2) {
                gi.sound(other, CHAN_ITEM, gi.soundindex("items/s_health.wav"),
                        1, ATTN_NORM, 0);
            } else if (ent->count == 10) {
                gi.sound(other, CHAN_ITEM, gi.soundindex("items/n_health.wav"),
                        1, ATTN_NORM, 0);
            } else if (ent->count == 25) {
                gi.sound(other, CHAN_ITEM, gi.soundindex("items/l_health.wav"),
                        1, ATTN_NORM, 0);
            } else { // (ent->count == 100)
                gi.sound(other, CHAN_ITEM, gi.soundindex("items/m_health.wav"),
                        1, ATTN_NORM, 0);
            }
...
gitem_t itemlist[] =
        {
                 ...
                 */
                { "item_armor_body", Pickup_Armor,
                NULL,
                NULL,
                NULL, "misc/ar1_pkup.wav", "models/items/armor/body/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"i_bodyarmor",
                        /* pickup */"Body Armor",
                        /* width */3, 0, 0,
                        IT_ARMOR, 0, &bodyarmor_info,
                        ARMOR_BODY,
                        /* precache */"", "RedArmor" },

                /*QUAKED item_armor_combat (.3 .3 1) (-16 -16 -16) (16 16 16)
                 */
                { "item_armor_combat", Pickup_Armor,
                NULL,
                NULL,
                NULL, "misc/ar1_pkup.wav", "models/items/armor/combat/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"i_combatarmor",
                        /* pickup */"Combat Armor",
                        /* width */3, 0, 0,
                        IT_ARMOR, 0, &combatarmor_info,
                        ARMOR_COMBAT,
                        /* precache */"", "YellowArmor", },

                /*QUAKED item_armor_jacket (.3 .3 1) (-16 -16 -16) (16 16 16)
                 */
                { "item_armor_jacket", Pickup_Armor,
                NULL,
                NULL,
                NULL, "misc/ar1_pkup.wav", "models/items/armor/jacket/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"i_jacketarmor",
                        /* pickup */"Jacket Armor",
                        /* width */3, 0, 0,
                        IT_ARMOR, 0, &jacketarmor_info,
                        ARMOR_JACKET,
                        /* precache */"", "GreenArmor", },

                /*QUAKED item_armor_shard (.3 .3 1) (-16 -16 -16) (16 16 16)
                 */
                { "item_armor_shard", Pickup_Armor,
                NULL,
                NULL,
                NULL, "misc/ar2_pkup.wav", "models/items/armor/shard/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"i_jacketarmor",
                        /* pickup */"Armor Shard",
                 ...
                 */
                { "item_power_screen", Pickup_PowerArmor, Use_PowerArmor,
                        Drop_PowerArmor,
                        NULL, "misc/ar3_pkup.wav",
                 ...
                 */
                { "item_power_shield", Pickup_PowerArmor, Use_PowerArmor,
                        Drop_PowerArmor,
                        NULL, "misc/ar3_pkup.wav",
                ...
                { "weapon_blaster",
                NULL, Use_Weapon,
                NULL, Weapon_Blaster, "misc/w_pkup.wav",
                NULL, 0, "models/weapons/v_blast/tris.md2",
                /* icon */"w_blaster",
                /* pickup */"Blaster", 0, 0, 0,
                 ...
                 */
                { "weapon_shotgun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        Weapon_Shotgun, "misc/w_pkup.wav",
                        "models/weapons/g_shotg/tris.md2", EF_ROTATE,
                        "models/weapons/v_shotg/tris.md2",
                        /* icon */"w_shotgun",
                        /* pickup */"Shotgun", 0, 1, ITEM_AMMO_SHELLS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_SHOTGUN,
                        NULL, 0,
                ...
                { "weapon_supershotgun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        ...
                        /* icon */"w_sshotgun",
                        /* pickup */"Super Shotgun", 0, 2, ITEM_AMMO_SHELLS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_SUPERSHOTGUN,
                        NULL, 0,
                        /* precache */"weapons/sshotf1b.wav", "SSG" },

                /*QUAKED weapon_machinegun (.3 .3 1) (-16 -16 -16) (16 16 16)
                 */
                { "weapon_machinegun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        Weapon_Machinegun, "misc/w_pkup.wav",
                        "models/weapons/g_machn/tris.md2", EF_ROTATE,
                        "models/weapons/v_machn/tris.md2",
                        /* icon */"w_machinegun",
                        /* pickup */"Machinegun", 0, 1, ITEM_AMMO_BULLETS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_MACHINEGUN,
                        NULL, 0,
                ...
                { "weapon_chaingun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        Weapon_Chaingun, "misc/w_pkup.wav",
                        "models/weapons/g_chain/tris.md2", EF_ROTATE,
                        "models/weapons/v_chain/tris.md2",
                        /* icon */"w_chaingun",
                        /* pickup */"Chaingun", 0, 1, ITEM_AMMO_BULLETS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_CHAINGUN,
                        NULL, 0,
                 ...
                 */
                { "ammo_grenades", Pickup_Ammo, Use_Weapon, Drop_Ammo,
                        Weapon_Grenade, "misc/am_pkup.wav",
                        "models/items/ammo/grenades/medium/tris.md2", 0,
                        "models/weapons/v_handgr/tris.md2",
                        /* icon */"a_grenades",
                        /* pickup */"Grenades",
                        /* width */3, 5, ITEM_AMMO_GRENADES,
                        IT_AMMO | IT_WEAPON,
                        WEAP_GRENADES,
                        NULL,
                        AMMO_GRENADES,
                 ...
                 */
                { "weapon_grenadelauncher", Pickup_Weapon, Use_Weapon,
                        Drop_Weapon, Weapon_GrenadeLauncher, "misc/w_pkup.wav",
                        "models/weapons/g_launch/tris.md2", EF_ROTATE,
                        "models/weapons/v_launch/tris.md2",
                        /* icon */"w_glauncher",
                        /* pickup */"Grenade Launcher", 0, 1,
                        ITEM_AMMO_GRENADES,
                        IT_WEAPON | IT_STAY_COOP,
                 ...
                 */
                { "weapon_rocketlauncher", Pickup_Weapon, Use_Weapon,
                        Drop_Weapon, Weapon_RocketLauncher, "misc/w_pkup.wav",
                        "models/weapons/g_rocket/tris.md2", EF_ROTATE,
                        "models/weapons/v_rocket/tris.md2",
                        /* icon */"w_rlauncher",
                        /* pickup */"Rocket Launcher", 0, 1, ITEM_AMMO_ROCKETS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_ROCKETLAUNCHER,
                        NULL, 0,
                ...
                { "weapon_hyperblaster", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        ...
                        /* icon */"w_hyperblaster",
                        /* pickup */"HyperBlaster", 0, 1, ITEM_AMMO_CELLS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_HYPERBLASTER,
                        NULL, 0,
                 ...
                 */
                { "weapon_railgun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        Weapon_Railgun, "misc/w_pkup.wav",
                        "models/weapons/g_rail/tris.md2", EF_ROTATE,
                        "models/weapons/v_rail/tris.md2",
                        /* icon */"w_railgun",
                        /* pickup */"Railgun", 0, 1, ITEM_AMMO_SLUGS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_RAILGUN,
                        NULL, 0,
                        /* precache */"weapons/rg_hum.wav", "RG" },

                /*QUAKED weapon_bfg (.3 .3 1) (-16 -16 -16) (16 16 16)
                 */
                { "weapon_bfg", Pickup_Weapon, Use_Weapon, Drop_Weapon,
                        Weapon_BFG, "misc/w_pkup.wav",
                        "models/weapons/g_bfg/tris.md2", EF_ROTATE,
                        "models/weapons/v_bfg/tris.md2",
                        /* icon */"w_bfg",
                        /* pickup */"BFG10K", 0, 50, ITEM_AMMO_CELLS,
                        IT_WEAPON | IT_STAY_COOP,
                        WEAP_BFG,
                        NULL, 0,
                 ...
                 */
                { "ammo_shells", Pickup_Ammo,
                NULL, Drop_Ammo,
                NULL, "misc/am_pkup.wav",
                 ...
                 */
                { "item_quad", Pickup_Powerup, Use_Quad, Drop_General,
                NULL, "items/pkup.wav", "models/items/quaddama/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"p_quad",
                        /* pickup */"Quad Damage",
                 ...
                 */
                { "item_invulnerability", Pickup_Powerup, Use_Invulnerability,
                        Drop_General,
                        NULL, "items/pkup.wav",
                 ...
                 */
                { "item_silencer", Pickup_Powerup, Use_Silencer, Drop_General,
                NULL, "items/pkup.wav", "models/items/silencer/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"p_silencer",
                        /* pickup */"Silencer",
                 ...
                 */
                { "item_breather", Pickup_Powerup, Use_Breather, Drop_General,
                NULL, "items/pkup.wav", "models/items/breather/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"p_rebreather",
                        /* pickup */"Rebreather",
                 ...
                 */
                { "item_enviro", Pickup_Powerup, Use_Envirosuit, Drop_General,
                NULL, "items/pkup.wav", "models/items/enviro/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"p_envirosuit",
                        ...
                        IT_STAY_COOP | IT_POWERUP, 0,
                        NULL, 0,
                        /* precache */"items/airout.wav", "E.Suit" },

                /*QUAKED item_ancient_head (.3 .3 1) (-16 -16 -16) (16 16 16)
                 Special item that gives +2 to maximum health
                 */
                { "item_ancient_head", Pickup_AncientHead,
                NULL,
                NULL,
                ...
                NULL,
                NULL,
                NULL, "items/pkup.wav", "models/items/adrenal/tris.md2",
                        EF_ROTATE,
                        NULL,
                        /* icon */"p_adrenaline",
                        /* pickup */"Adrenaline",
                 ...
                 */
                { "item_bandolier", Pickup_Bandolier,
                NULL,
                NULL,
                NULL, "items/pkup.wav", "models/items/band/tris.md2", EF_ROTATE,
                NULL,
                /* icon */"p_bandolier",
                /* pickup */"Bandolier",
                /* width */2, 60, 0, 0, 0,
                 ...
                 */
                { "item_pack", Pickup_Pack,
                NULL,
                NULL,
                NULL, "items/pkup.wav", "models/items/pack/tris.md2", EF_ROTATE,
                NULL,
                /* icon */"i_pack",
                /* pickup */"Ammo Pack",
                /* width */2, 180, 0, 0, 0,
...
void SetItemNames(void) {
    ...
    for (i = 0; i < game.num_items; i++) {
        ...
        if (it->pickup_name && it->pickup_name[0]) {
